  ...
  <section className="py-32 relative">
    <div className="container">
      ...
      >
        ...
        <h2 className="text-4xl md:text-5xl font-extrabold mb-6 relative z-10 text-primary-foreground">
          今すぐAndroid 18を体験 🎉
        </h2>
        <p className="text-primary-foreground/80 text-lg max-w-xl mx-auto mb-10 relative z-10">
          無料プランで全機能をお試しいただけます。クレジットカード不要。
        </p>
        <button className="bg-primary-foreground text-foreground px-10 py-4 rounded-full font-bold text-lg transition-all hover:scale-105 hover:shadow-lg relative z-10">
          🎀 無料アカウントを作成
        </button>
      </motion.div>
    </div>
